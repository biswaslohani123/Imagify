  ...
  return (
    ...
    <form onSubmit={onSubmitHandler} className='relative bg-white p-10 rounded-xl text-slate-500'>
        ...
        <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
            ...
            <input onChange={(e) => setPassword(e.target.value)} value={password} className='outline-none text-sm' type="text" placeholder='Password' required />
        </div>
        ...
        {
            state === 'Login' ? <p className='mt-5 text-center'>Don't have an account? <span className='text-blue-600 cursor-pointer' onClick={(e) => setState('Sign Up')}>Sign up </span></p> : 
