  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col min-h-[90vh] justify-center items-center' >
      ...
      <div className='relative'>
            ...
            <span className={`absolute bg-blue-500 w-full h-1 left-0 bottom-0 ${loading ? 'w-full transition-all duration-[10s]' : 'w-0'} `}/>
      </div>
    ...
    }
    {
      ...
      <div className='flex gap-2 flex-wrap justify-center  text-sm p-0.5 mt-10 rounded-full text-white'>
